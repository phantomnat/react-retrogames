              ...
              <form name="product-form" action="" onSubmit={() => this.props.submit()} noValidate>
                ...
                <div className="form-group text-left">
                  ...
                  <textarea id="description" type="text" className="form-control"
                    placeholder="Enter the description" rows="5" onChange={() => this.props.setGame()}>
                  </textarea>
                </div>
                <div className="form-group text-left">
                  <label htmlFor="price">Year</label>
                  <input id="year" type="number" className="form-control"
                    placeholder="Enter the year" onChange={() => this.props.setGame()} />
                </div>
                <div className="form-group text-left">
                  <label htmlFor="picture">Picture</label>
                  <div className="text-center dropup">
                    <button id="button-upload" type="button" className="btn btn-danger"
                ...
                <div className="form-group text-center">
                  <img id="picture" className="img-response img-upload" />
                </div>
